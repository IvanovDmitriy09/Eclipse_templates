...
void SystaemCoreClockUpdate(void){
#ifdef SYSCLK_FREQ_HSE
...
#elif defined SYSCLK_FREQ_96MHz
SystemCoreClock         = SYSCLK_FREQ_96MHz;        /*!< System Clock Frequency (Core Clock) */
#elif defined SYSCLK_HSI_48MHz
...
#elif defined SYSCLK_HSI_96MHz
SystemCoreClock         = SYSCLK_HSI_96MHz;        /*!< System Clock Frequency (Core Clock) */
#else /*!< HSI Selected as System Clock source */
SystemCoreClock         = HSI_VALUE_PLL_OFF;        /*!< System Clock Frequency (Core Clock) */
#endif
}
...
void SetSysClockTo48_HSI()
{
    ...
    RCC->CR &= ~(0x1f << 26);
    RCC->CR |= (4 - 1) << 26; //����PLLֵ 2~16

    FLASH->ACR = FLASH_ACR_LATENCY_1 | FLASH_ACR_PRFTBE;	 //FLASH 2����ʱ����
...
void SetSysClockTo96_HSI()
{
    ...
    RCC->CR &= ~(0x1f << 26);
    RCC->CR |= (8 - 1) << 26; //����PLLֵ 2~16

    FLASH->ACR = FLASH_ACR_LATENCY_1 | FLASH_ACR_LATENCY_0 | FLASH_ACR_PRFTBE;	 //FLASH 2����ʱ����
