...
typedef enum IRQn {
    ...
    PVD_VDT_IRQn                        = 1,                                     ///< Power voltage detection (PVD) connected to EXTI16 and CORE voltage detection (VDT) interrupt
    ...
    CAN1_IRQn                           = 21,                                    ///< CAN1 global interrupt
    EXTI9_5_IRQn                        = 23,                                    ///< EXTI line [9: 5] interrupted
    TIM1_BRK_IRQn                       = 24,                                    ///< TIM1 disconnect interrupt
    TIM1_UP_IRQn                        = 25,                                    ///< TIM1 update interrupt
    TIM1_TRG_COM_IRQn                   = 26,                                    ///< TIM1 trigger and communication interrupt
    ...
    ENET_IRQn                           = 61,                                    ///< ETHERNET global interrupt
    COMP1_2_IRQn                        = 64,                                    ///< Comparator 1/2 interrupt connected to EXTI
    USB_OTGFS_IRQn                      = 67,                                    ///< USB FS global interrupt
