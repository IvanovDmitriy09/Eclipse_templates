/**
  **************************************************************************
  * @file     at32l021_crm.h
  * @brief    at32l021 crm header file
  **************************************************************************
...
#ifndef __AT32L021_CRM_H
#define __AT32L021_CRM_H
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved8            : 2; /* [24:23] */
      __IO uint32_t can1rst              : 1; /* [25] */
      __IO uint32_t reserved9            : 2; /* [27:26] */
      __IO uint32_t pwcrst               : 1; /* [28] */
      __IO uint32_t reserved10           : 3; /* [31:29] */
    } apb1rst_bit;
  };
